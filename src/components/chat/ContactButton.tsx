...
const OUTLOOK_URL = `https://outlook.live.com/mail/0/deeplink/compose?to=${encodeURIComponent(EMAIL)}`;
const MAILTO_URL = `mailto:${EMAIL}`;

interface Props {
  className?: string;
  // Optional trigger override — when provided, replaces the default pill
  // trigger so callers (e.g. contact cards) can render their own surface.
...
function GmailIcon() {
  // Gmail 2026 logo (Wikimedia Commons).
  return (
    <svg
      aria-label="Gmail"
...
function OutlookIcon() {
  // Outlook 2025+ logo (Wikimedia Commons).
  return (
    <svg
      aria-label="Outlook"
    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset=".2369" stopColor="#448aff" stopOpacity="0" />
          <stop offset=".7921" stopColor="#0032b1" stopOpacity=".2" />
        </linearGradient>
        <linearGradient
          id="outlook-d"
          x1="24.0534"
        ...
        >
          ...
          <stop offset=".6699" stopColor="#0d1f69" stopOpacity=".2" />
        </linearGradient>
        <linearGradient
          id="outlook-g"
          x1="41.998"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset=".2059" stopColor="#6ce0ff" />
        ...
        <radialGradient
          ...
          fx="0"
          fy="0"
          gradientTransform="matrix(0 -405.040512 438.393002 0 360.027 102.2682)"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset=".5682" stopColor="#275ff0" stopOpacity="0" />
          <stop offset=".9924" stopColor="#002177" />
        </radialGradient>
        <radialGradient
          id="outlook-h"
          cx="0"
          ...
          fx="0"
          fy="0"
          gradientTransform="rotate(-45 897.148 -224.3274) scale(173.58)"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset=".2595" stopColor="#0060d1" stopOpacity=".4" />
          <stop offset=".9082" stopColor="#0383f1" stopOpacity="0" />
        </radialGradient>
        <radialGradient
          id="outlook-i"
          cx="0"
          ...
          fx="0"
          fy="0"
          gradientTransform="rotate(-52.6577 784.0595 187.4118) scale(589.220981 532.806015)"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset=".7323" stopColor="#f4a7f7" stopOpacity="0" />
        ...
        <radialGradient
          ...
          fx="0"
          fy="0"
          gradientTransform="matrix(0 167.999997 -193.782005 0 180 491.1585)"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset=".5578" stopColor="#0fa5f7" stopOpacity="0" />
      ...
      <path
        fill="url(#outlook-f)"
        fillRule="nonzero"
        d="M410.1875 105.25c-30.5-19.7852-69.7812-19.7812-100.2812.0078L109.7422 235.1445c-12.2969 7.9766-19.7188 21.6368-19.7188 36.293v1.9688c.4844 14.7148 8.2266 28.2734 20.7344 36.1601l248.8867 156.9102 249.5157-156.672c12.9609-8.1366 20.8242-22.3632 20.8242-37.664v38.168l.0078-38.9649c0-14.6601-7.4258-28.3203-19.7227-36.3007Zm0 0"
      />
      <path
        fill="url(#outlook-g)"
        fillRule="nonzero"
      ...
      <path
        fill="#ffffff"
        fillRule="nonzero"
        d="M179.3867 534c-19.8476 0-36.1367-6.211-48.875-18.625s-19.1094-28.6172-19.1094-48.6055c0-21.1093 6.4649-38.1797 19.3946-51.2187C143.7305 402.5156 160.6602 396 181.5938 396c19.7812 0 35.8789 6.2383 48.2968 18.7148 12.4844 12.4766 18.7266 28.9297 18.7266 49.3516 0 20.9844-6.4688 37.8984-19.3984 50.75C216.3516 527.6054 199.7422 534 179.3868 534m.5742-26.3516c10.8164 0 19.5235-3.6953 26.1172-11.082s9.8906-17.664 9.8906-30.8242c0-13.7188-3.203-24.3945-9.6015-32.0313-6.4024-7.6367-14.9492-11.453-25.6367-11.453-11.0118 0-19.879 3.9413-26.5977 11.8241-6.7226 7.8243-10.082 18.1914-10.082 31.1016 0 13.1016 3.3594 23.4687 10.082 31.1016 6.7188 7.5742 15.3281 11.3632 25.8281 11.3632m0 0"
      />
      <path
        fill="#ffffff"
        fillRule="nonzero"
