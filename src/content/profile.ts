...
export const profile = {
  ...
  projects: [
    ...
    {
      title: "OinkBooks — V2",
      url: "https://project-oinkbooks-v2.vercel.app",
      summary:
        "Personal expense tracker — visualize purchases on a calendar, table, and category chart. Originally built on Next.js + Firebase, rebuilt feature-for-feature onto a modern Angular + NestJS + Postgres stack.",
      tags: ["Angular", "NestJS", "Postgres", "TypeScript", "RxJS"],
      image: "/images/projects/oinkbooks.png",
      imageAlt: "Screenshot of OinkBooks dashboard",
      gallery: [
        "/images/projects/oinkbooks-purchases.png",
        "/images/projects/oinkbooks-add-dialog.png",
